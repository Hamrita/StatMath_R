...
description: Pratiquons un peu le langage R. 
---
...
## Introduction 
Dans ce tutoriel, nous allons apprendre à pratiquer le langage *R*. Nous commençons par l'installation du logiciel *R* ainsi que *RStudio*
  
### Installation

La video suivante, vous montre les étapes à suivre pour installer *R* et *RStudio* (environnement pour *R*).

<iframe width="560" height="315" src="https://www.youtube.com/watch?v=4ZhaB_kbTKc&list=PLVMtMDWXCQ364TxQxXdUZfyMmiXe9YIPH&index=3" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

### Initiation au langage R

Afin d'apprendre les bases du langage *R* et savoir les différents types d'objets, nous vous conseillons de consulter le notebook suivant: ![](https://github.com/Hamrita/Statistique-Mathematique/blob/main/Initiation%20R/TP1_R.ipynb)
